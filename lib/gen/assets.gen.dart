...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/right_arrow_outline.svg
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/logo_128.png
  AssetGenImage get logo128 =>
      const AssetGenImage('assets/images/logo_128.png');

  /// File path: assets/images/logo_256.png
  AssetGenImage get logo256 =>
      const AssetGenImage('assets/images/logo_256.png');

  /// File path: assets/images/logo_32.png
  AssetGenImage get logo32 => const AssetGenImage('assets/images/logo_32.png');

  /// File path: assets/images/logo_512.png
  AssetGenImage get logo512 =>
      const AssetGenImage('assets/images/logo_512.png');

  /// File path: assets/images/logo_64.png
  AssetGenImage get logo64 => const AssetGenImage('assets/images/logo_64.png');

  /// List of all assets
  List<AssetGenImage> get values => [logo128, logo256, logo32, logo512, logo64];
}

class $AssetsLottieGen {
  const $AssetsLottieGen();

  /// File path: assets/lottie/money_lottie.json
  String get moneyLottie => 'assets/lottie/money_lottie.json';

  /// List of all assets
  List<String> get values => [moneyLottie];
}
